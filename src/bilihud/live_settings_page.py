...
from PyQt6.QtCore import QEvent, QObject, QPoint, Qt, pyqtSignal, pyqtSlot
...
from .config.store import DEFAULT_OBS_HOST, DEFAULT_OBS_PORT
...
from .live_credentials import LiveCredentials
from .live_settings_workflow import LiveAction, LiveSettingsForm, LiveSettingsWorkflow
from .settings_style import ModernComboBox


class _LiveVerificationDialog(QDialog):
...
class LiveSettingsPage(QWidget):
    ...
    def __init__(
        ...
        self._workflow = LiveSettingsWorkflow(service, task_scope, self)
        self._init_ui()
    ...
    def show_verification(self, url: str, kind: LiveVerificationKind) -> None:
        ...
        dialog = _LiveVerificationDialog(self, url, kind, image_bytes)
